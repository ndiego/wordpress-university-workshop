...
<!-- wp:cover {"url":"<?php echo esc_url( get_stylesheet_directory_uri() ); ?>/assets/images/campus-1.jpg","id":224,"dimRatio":40,"focalPoint":{"x":0.48999999999999999,"y":0.20999999999999999},"minHeight":300,"isDark":false,"align":"full","style":{"spacing":{"padding":{"right":"var:preset|spacing|30","left":"var:preset|spacing|30"},"margin":{"top":"0","bottom":"clamp(2.5rem, 8vw, 4.5rem)"}}},"textColor":"base","layout":{"type":"constrained"}} -->
<div class="wp-block-cover alignfull is-light has-base-color has-text-color" style="margin-top:0;margin-bottom:clamp(2.5rem, 8vw, 4.5rem);padding-right:var(--wp--preset--spacing--30);padding-left:var(--wp--preset--spacing--30);min-height:300px"><span aria-hidden="true" class="wp-block-cover__background has-background-dim-40 has-background-dim"></span><img class="wp-block-cover__image-background wp-image-224" alt="" src="<?php echo esc_url( get_stylesheet_directory_uri() ); ?>/assets/images/campus-1.jpg" style="object-position:49% 21%" data-object-fit="cover" data-object-position="49% 21%"/><div class="wp-block-cover__inner-container"><!-- wp:query-title {"type":"archive","align":"wide"} /--></div></div>
<!-- /wp:cover -->
