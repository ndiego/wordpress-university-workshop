...
<!-- wp:cover {"url":"<?php echo esc_url( get_stylesheet_directory_uri() ); ?>/assets/images/campus-2.jpg","id":225,"dimRatio":30,"focalPoint":{"x":0.46999999999999997,"y":0.65000000000000002},"minHeight":300,"align":"full","style":{"spacing":{"padding":{"right":"var:preset|spacing|30","left":"var:preset|spacing|30"},"margin":{"top":"0","bottom":"clamp(2.5rem, 8vw, 4.5rem)"}}},"textColor":"base","layout":{"type":"constrained"}} -->
<div class="wp-block-cover alignfull has-base-color has-text-color" style="margin-top:0;margin-bottom:clamp(2.5rem, 8vw, 4.5rem);padding-right:var(--wp--preset--spacing--30);padding-left:var(--wp--preset--spacing--30);min-height:300px"><span aria-hidden="true" class="wp-block-cover__background has-background-dim-30 has-background-dim"></span><img class="wp-block-cover__image-background wp-image-225" alt="" src="<?php echo esc_url( get_stylesheet_directory_uri() ); ?>/assets/images/campus-2.jpg" style="object-position:47% 65%" data-object-fit="cover" data-object-position="47% 65%"/><div class="wp-block-cover__inner-container"><!-- wp:query-title {"type":"search","align":"wide"} /-->
...
<p class="has-text-align-left has-small-font-size">It looks like no posts could be found. Try a different search.</p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
